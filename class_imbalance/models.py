...
class ResNet_s(nn.Module):
    ...
    def __init__(self, block, num_blocks, num_classes=10, use_norm=False, width=1):
        ...
        if use_norm:
            self.linear = NormedLinear(64 * width, num_classes)
        else:
...
def resnet32(**kwargs):
    return ResNet_s(BasicBlock, [5, 5, 5], **kwargs)
